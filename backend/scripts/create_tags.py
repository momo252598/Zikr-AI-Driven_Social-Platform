"""
Script to create default tags for the social application.
Run this script to populate the database with predefined tags.

Usage:
    python manage.py shell < scripts/create_tags.py
"""
