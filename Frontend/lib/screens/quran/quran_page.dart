...
class _QuranViewPageState extends State<QuranViewPage> {
  ...
  final Map<int, String> _clusterTopics = {
    0: 'الأوامر الإلهية والأحكام الشرعية',
    1: 'الجهاد والقتال في سبيل الله',
    2: 'رحمة الله ومغفرته',
    3: 'الرسول محمد والوحي',
    4: 'التوحيد وعبادة الله',
    5: 'عذاب النار وأهل الكفر',
    6: 'الهداية والضلال',
    7: 'ربوبية الله وحمده',
    8: 'الأعمال الصالحة والإيمان',
    9: 'نعيم الجنة وثمارها',
    10: 'التكذيب والصراع بين الحق والباطل',
    11: 'المؤمنون وثواب الجنة',
    12: 'تسخير الكون للإنسان',
    13: 'شدة العذاب الإلهي',
    14: 'مقارنة الدنيا بالآخرة',
    15: 'قصص الأنبياء مع أقوامهم',
    16: 'عظمة خلق السماوات والأرض',
    17: 'نعمة الماء والغيث',
    18: 'قصص موسى ',
    19: 'بلاغة القرآن وأسلوبه التربوي',
  };
